              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  ...
                  >
                    ...
                    <b-dropdown-item :to="{ name: 'loguot' }"
...
export default {
  ...
  data() {
    return {
      titulo: document.title.toUpperCase(),
      template: "back",
  ...
  watch: {
    $route() {
      this.titulo = document.title.toUpperCase();
    }
  },
  methods: {
    recibir() {
    ...
    validate() {
      let me = this;
      axios.post(API_HOST + "/auth/validate").then(function(response) {
